...
int				main()
{
	...
	/*if(-1 == (vertexcolorLocation = glGetUniformLocation(program, "vertexColor")))
	{
		fprintf(stderr, "Cannot find the uniform location\n");
		exit(1);
	}*/
	while(!is_closed)
	{
		...
		glUseProgram(program);
			//glUniform4f(vertexcolorLocation, 0.0f,0.0f, color ,1.0f);
			glBindVertexArray(VAO);
