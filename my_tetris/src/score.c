...
void			score_info(t_board *b)
{
	...
	mlx_string_put(b->e->mlx, b->e->win, 220, 50, 0x0000FF, "I");
	mlx_string_put(b->e->mlx, b->e->win, 220, 70, 0x00FEDC, "B");
	mlx_string_put(b->e->mlx, b->e->win, 220, 90, 0x00FF00, "T");
	mlx_string_put(b->e->mlx, b->e->win, 220, 110, 0x00FEDC, "R");
	mlx_string_put(b->e->mlx, b->e->win, 220, 130, 0xFF0000, "A");
	mlx_string_put(b->e->mlx, b->e->win, 220, 150, 0x00FEDC, "0");
	mlx_string_put(b->e->mlx, b->e->win, 220, 170, 0x0000FF, "R");
	mlx_string_put(b->e->mlx, b->e->win, 220, 190, 0x00FEDC, "E");
