...
void			score_info(t_board *b)
{
	...
	mlx_string_put(b->e->mlx, b->e->win, 480, 50, 0x0000FF, "O");
	mlx_string_put(b->e->mlx, b->e->win, 480, 70, 0x00FEDC, "R");
	mlx_string_put(b->e->mlx, b->e->win, 480, 90, 0x00FF00, "G");
	mlx_string_put(b->e->mlx, b->e->win, 480, 110, 0x00FEDC, "E");
	mlx_string_put(b->e->mlx, b->e->win, 480, 130, 0xFF0000, "E");
	mlx_string_put(b->e->mlx, b->e->win, 480, 150, 0x00FEDC, "K");
	mlx_string_put(b->e->mlx, b->e->win, 480, 170, 0x0000FF, ":");
	mlx_string_put(b->e->mlx, b->e->win, 480, 190, 0x00FEDC, ":");
